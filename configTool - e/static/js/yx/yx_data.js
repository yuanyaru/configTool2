...
$(document).ready(function () {
    ...
    $("#contect").click(function () {
        /*window.confirm("Thank you for using our product ！\n" +
                        "If you have any questions during using，" +
            "please contact yuanyaru in the platform development department!");*/
        $.confirm({
            title: 'GMT',
            content: 'Thank you for using our product ！' + '<br/>' +
                'If you have any questions during using，' +
                'please contact yuanyaru in the platform development department.',
            buttons: {
    ...
    $("#about").click(function () {
        /*window.confirm("product：ConfigTool\n" +
                       "version：v1.0.0");*/
        $.confirm({
            title: 'GMT',
            content: 'Product：ConfigTool' + '<br/>' +
                'Version：v1.0.0',
            buttons: {
                ok:{text:'OK', btnClass:'btn-primary'},
                // cancle:{text:'cancle', btnClass:'btn-danger'}
...
function show_db_yx_data() {
    $.post("/yx_data", {'stationId': stationId}, function(res) {
        ...
        if (resLen > 2) {
            ...
            document.getElementById("tBody_yx").innerHTML = "No Data！！！";
        }
    });
}
