...
function show_db_soe_data() {
    document.getElementById("tBody_soe").innerHTML = "<span style='font-size:22px; color:red;'>正在努力加载数据......</span>";
    $.post("/soe_data", {'stationId': stationId}, function(res){
        ...
        if (resLen > 2) {
            ...
            document.getElementById("tBody_soe").innerHTML = "<span style='font-size:22px; color:red;'>没有事件数据可显示！！！</span>";
        }
    });
}
