...
function show_db_yx_data() {
    document.getElementById("tBody_yx").innerHTML = "<span style='font-size:22px; color:red;'>正在努力加载数据......！</span>";
    $.post("/yx_data", {'stationId': stationId}, function(res) {
        ...
        if (resLen > 2) {
            ...
            document.getElementById("tBody_yx").innerHTML = "<span style='font-size:22px; color:red;'>没有遥信数据可显示！！！</span>";
        }
    });
}
